...
def Usage():
    ...
    print('  featureMetaFolder: specify a folder containing all the features, under which each protein has an '
          'independent feature folder named after feat_proteinName_contact')
    print('  This script reads only protein features for distance prediciton. To load the true distance matrix, '
          'please use AddAtomDistance.py in Utils/')
